...
public class SwitchButton extends Component {
    ...
    public SwitchButton() {
        ...
        setPreferredSize(new Dimension(40, 20));  // Reducir tamaño
        setForeground(Color.WHITE);
        setCursor(new Cursor(Cursor.HAND_CURSOR));
        events = new ArrayList<EventSwitchSelected>();
        location = 2;
    ...
    public void paint(Graphics g) {
        ...
        g2.fillOval((int) location, 2, height - 4, height - 4);  // El botón se ajusta al tamaño más pequeño
        super.paint(g);
    }
